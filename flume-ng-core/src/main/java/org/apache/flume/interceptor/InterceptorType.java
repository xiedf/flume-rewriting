...
public enum InterceptorType {
  ...
  EVENT_HANDLER(org.apache.flume.interceptor.EventHandlerInterceptor.Builder.class),
  REGEX_FILTER(
  ...
  WEB_LOGIC_APP_EXTRACTOR(org.apache.flume.interceptor.WebLogicAppExtractorInterceptor.Builder.class);
